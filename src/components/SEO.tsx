...
export default function SEO({ 
  ...
  const pageTitle = `${title} ${!shouldExcludeTitleSuffix ? '| JoJoCommerce' : ''}`;
  ...
  return (
    <Head>
      ...
      { title && <meta property="og:site_name" content={pageTitle} />}
      {image && <meta property="og:image" content={pageImage} />}
      {image && <meta property="og:image:secure_url" content={pageImage} />}
      ...
      {image && <meta name="twitter:image:src" content={pageImage} />}
